  ...
  return (
    <div className="meet-page">
      ...
      <div className="meet-chat">
        ...
        ):(<div className="meet-empty"><div style={{ marginBottom: 16, display: "flex", justifyContent: "center" }}>{tab === "chat" ? <img src="/assets/meet.png" alt="Meet" style={{ width: 48, height: 48, objectFit: "contain" }} /> : <img src="/assets/voice.png" alt="Voice" style={{ width: 48, height: 48, objectFit: "contain" }} />}</div><h3 style={{color:"#fff",marginBottom:8}}>{tab==="chat"?"Select a conversation":"Join a voice room"}</h3><p style={{color:"#555"}}>{tab==="chat"?"Choose a conversation or start one":"Select a room or create one"}</p></div>)}
      </div>
